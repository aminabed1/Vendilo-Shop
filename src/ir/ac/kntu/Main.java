...
//        Customer customer = new Customer("amin", "abddd", "09144593348", "aafdsz@adsf", "amin1amin1","12345678aA@");
        Support support = new Support("Amin", "abdollahi", "aminabed1", "12345678aA@");
//        Seller seller = new Seller("amin", "aaaaaa", "09144593347", "adsv@gmail.com", "123456789abcd", "12345678aA@", "aa", "14569874588", "TEHRAN","AA2S3D4");
