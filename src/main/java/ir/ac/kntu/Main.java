...
public class Main {
    public static void main(String[] args) {
        ...
        LopTop loptop = new LopTop("ASUS", "4000", "512", "16", "Windows", "Core i7", "RTX 5090", false, false, "DDR5", 2, "AA2S3D4");

        DiscountCode discountCode = new PercentDiscount("ABCD", "09144593348", true, 10, 10);
